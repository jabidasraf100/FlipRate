// Static {code, name} list, restricted to codes actually returned by
// ExchangeRate-API's free /latest/USD endpoint so every option is convertible.
const CURRENCIES = [
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = { CURRENCIES, formatCurrencyOption };
}
